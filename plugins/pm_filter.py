    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                await query.answer('Check mia bot, I have sent files in mia bot',show_alert = True)
        ...
        buttons= [[
            InlineKeyboardButton('🤖 join channel', url='https://t.me/joinchat/BxHECAcVl8xmNTg9'),
            InlineKeyboardButton('♥️ Source', url='https://t.me/joinchat/6seI81n7T3wyODZl')
            ],[
            InlineKeyboardButton('🏠 Home', callback_data='start'),
...
async def auto_filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        if imdb and imdb.get('poster'):
            ...
            await message.reply_text(f"<b>Query: {search}</b> \n‌‌‌‌IMDb Data:\n\n🏷 Title: <a href={imdb['url']}>{imdb.get('title')}</a>\n🎭 Genres: {imdb.get('👉@bettermalayalam👈𝙅𝙤𝙞𝙣 𝙏𝙝𝙞𝙨 𝘾𝙝𝙖𝙣𝙣𝙚𝙡 𝘼𝙣𝙙 𝗣𝗿𝗲𝘀𝘀 𝗧𝗵𝗲 𝗗𝗼𝘄𝗻 𝗕𝘂𝘁𝘁𝗼𝗻𝘀 𝗧𝗼 𝗔𝗰𝗰𝗲𝘀𝘀 𝗧𝗵𝗲 𝗙𝗶𝗹𝗲 
